...
echo " "
sleep "3"
mysql --user=root --password=RooT12@9#hX -e "CREATE USER '$USERMYSQL'@'localhost' IDENTIFIED BY '$CONTRAMYSQLADMIN';"
mysql --user=root --password=RooT12@9#hX -e "GRANT ALL PRIVILEGES ON *.* TO '$USERMYSQL'@'localhost' WITH GRANT OPTION;"
mysql --user=root --password=RooT12@9#hX -e "FLUSH PRIVILEGES;"
